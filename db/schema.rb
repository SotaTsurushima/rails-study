...
ActiveRecord::Schema.define(version: 2023_02_23_084509) do
  ...
  create_table "fan_comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "author_no"
    t.string "name"
    t.text "body"
    t.boolean "deleted"
